...
namespace RealmAspNet.RealmEye.Proxy
{
	...
	public class Result
	{
		...
		[JsonProperty("last_verification")] public DateTimeOffset LastVerification { get; set; }
	...
	public class Ports
	{
		[JsonProperty("http")] public long Http { get; set; }

		[JsonProperty("socks5")] public long Socks5 { get; set; }
	}
}